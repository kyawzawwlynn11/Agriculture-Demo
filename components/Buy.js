    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          <View style={{flexDirection:'row',marginTop:20,marginLeft:10}}>
              ...
              <TouchableOpacity style={{flexDirection:'row',padding:10,backgroundColor:'white',borderWidth:1,marginLeft:15,marginTop:20,borderRadius:20,width:100,height:50,justifyContent:'center',alignContent:'center',alignItems:'center',elevation:10}}>
                <Text style={{color:'green'}}>အ၀ယ်</Text>
          ...
          <View style={{flexDirection:'row',marginTop:15,marginLeft:20}}>
            <TextInput placeholder='Min            0.0ကျပ်' keyboardType='numeric' style={{paddingLeft:15,borderWidth:1,width:155,height:50,borderRadius:10}}/>
            <TextInput placeholder='Max            0.0ကျပ်' keyboardType='numeric' style={{marginLeft:15,paddingLeft:15,borderWidth:1,width:155,height:50,borderRadius:10}}/>
          </View>
          <View style={{flexDirection:'row',marginTop:15,marginLeft:20}}>
            <TextInput placeholder='ဖုန်း   0978965432' keyboardType='numeric' style={{paddingLeft:15,borderWidth:1,width:155,height:50,borderRadius:10}}/> 
          </View>
          <View style={{flexDirection:'row',marginTop:15,marginLeft:20,borderWidth:1,width:'90%',height:'40%',borderRadius:10}}>
            <TextInput placeholder='Add more about your product.' multiline={true} keyboardType='default' style={{paddingLeft:15,paddingBottom:235}}/> 
          </View>
          <View style={{flexDirection:'row',marginTop:15,marginLeft:20}}>
